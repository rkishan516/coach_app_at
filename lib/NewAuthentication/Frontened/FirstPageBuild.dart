            ...
            onTap: () {
              setState(() {
                ...
                widget.animatorKey.refreshAnimation(
                    tween: Tween<Offset>(
                        begin: Offset(0, -0.11), end: Offset(0, -0.14)),
                    curve: Curves.easeInSine);
                widget.logoanimatorKey.refreshAnimation(
                    tween: Tween<Offset>(
                        begin: Offset(0, -0.7), end: Offset(0, -0.8)),
                    curve: Curves.easeInSine,
          ...
          GestureDetector(
              onTap: () {
                setState(() {
                  ...
                  widget.animatorKey.refreshAnimation(
                      tween: Tween<Offset>(
                          begin: Offset(0, 0.02), end: Offset(0, -0.03)),
                      curve: Curves.easeInSine,
                      duration: Duration(milliseconds: 500));
                  widget.circleanimatorKey.refreshAnimation(
                      tween: Tween<Offset>(
                          begin: Offset(-0.6, -0.20), end: Offset(-0.6, -0.25)),
                      curve: Curves.easeInSine,
                      duration: Duration(milliseconds: 500));
                  widget.logoanimatorKey.refreshAnimation(
                      tween: Tween<Offset>(
