                                  ...
                                  children: <Widget>[
                                    ...
                                    RaisedButton(
                                      onPressed: () async {
                                        ...
                                        if (keyC == null &&
                                            _courseSelected != null &&
                                            _subjectSelectedid != null &&
                                            _chapterSelected != null) {
                                          reference = FirebaseDatabase.instance
                                              .reference()
                                              .child(
                                                  'institute/${FireBaseAuth.instance.instituteid}/branches/${FireBaseAuth.instance.branchid}/courses/${_courseSelected.id}/subjects/$_subjectSelectedid/chapters/${_keych[_chapterSelected]}');
                                          try {
                                            await reference
                                                .child('content/')
                                                .push()
