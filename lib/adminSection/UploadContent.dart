...
class _UploadContentState extends State<UploadContent> {
  List<Courses> _courses = List<Courses>();
  Courses _courseSelected ;
  List<String> _subjects = List<String> ();
  String _subjectSelected, _subjectSelectedid ;
  List<String> _chapters = List<String>();
                      ...
                      children: <Widget>[
                        ...
                        RaisedButton(
                          onPressed: () async {
                            ...
                            if (keyC == null && _courseSelected!=null && _subjectSelectedid!=null && _chapterSelected!=null) {
                           reference = FirebaseDatabase.instance
                            .reference().child('institute/${FireBaseAuth.instance.instituteid}/branches/${FireBaseAuth.instance.branchid}/courses/${_courseSelected.id}/subjects/$_subjectSelectedid/chapters/${_keych[_chapterSelected]}');  
                           try{
                            await reference
                                  .child('content/')
                                  .push()
                            ...
                            _showsnackbar(context, "Content Added".tr());
                           }
                           catch(err){
                             _showsnackbar(context, "Failed. Please Try Again".tr());
                           }
