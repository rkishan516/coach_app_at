...
class StudentRequestListTile extends StatefulWidget {
  ...
  StudentRequestListTile({required this.keyS, this.student});
  @override
      ...
      child: Card(
        ...
        child: Column(
          ...
          children: [
            ...
            StreamBuilder<DatabaseEvent>(
                stream: ref.parent!.child('/courses/$selectedCourseID').onValue,
                builder: (context, snapshot) {
                  if (!snapshot.hasData) {
                    return Container();
                  }
                  Courses selectedCourse =
                      Courses.fromJson(snapshot.data!.snapshot.value as Map);
                  return ListView(
                    shrinkWrap: true,
                      ...
                      if (selectedCourse.fees?.oneTime.isOneTimeAllowed ??
                        ...
                        SwitchListTile.adaptive(
                          ...
                          value: widget
                              ...
                              false,
                          onChanged:
                              ((selectedCourse.fees?.oneTime.isOneTimeAllowed ??
                                          false) &&
                      ...
                      if (!(widget.student!.requestedCourseFee?.isPaidOneTime ??
                        ...
                        ListView.builder(
                          ...
                          itemBuilder: (context, index) {
                            if (widget.student!.requestedCourseFee!
                                    .installments ==
                                null) {
