...
class _$SubjectImpl extends _Subject {
  const _$SubjectImpl({required this.name, required this.courseId}) : super._();
  ...
  @override
  String toString() {
    return 'Subject(name: $name, courseId: $courseId)';
  }
...
abstract class _Subject extends Subject {
  const factory _Subject(
      ...
      required final String courseId}) = _$SubjectImpl;
