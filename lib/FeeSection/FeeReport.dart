...
class _FlutterreportState extends State<FeesReport> {
  ...
  _loadFromDatabase() async{
   DataSnapshot snapshot= await dbref.reference().child("institute/${FireBaseAuth.instance.instituteid}/branches/${FireBaseAuth.instance.branchid}/students").orderByChild("course/410665312/courseID").equalTo("410665312").once();
   ...
   map.forEach((key, value) { 
     if(value["course"]["410665312"]["fees"]!=null)
    _list.add(StudentModel.fromJSON(key, value,finesnapshot.value, "410665312"));
   });
   setState(() {
