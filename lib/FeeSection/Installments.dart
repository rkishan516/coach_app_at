...
class _InstallmentsState extends State<Installments> {
      ...
      return ListView.builder(
          ...
          itemBuilder: (context, index) {
            return GestureDetector(
              onLongPress: (){
                setState(() {
                  dbRef.reference().child("institute/${FireBaseAuth.instance.instituteid}/branches/${FireBaseAuth.instance.branchid}/courses/${widget.courseId}/fees")
  ...
  _saveintodatabase() {
    for(int i=0;i<noOfTextFields;i++){
      dbRef.reference().child("institute/${FireBaseAuth.instance.instituteid}/branches/${FireBaseAuth.instance.branchid}/courses/${widget.courseId}/fees").child("MaxInstallment/Installments").update({
     ...
     dbRef.reference().child("institute/${FireBaseAuth.instance.instituteid}/branches/${FireBaseAuth.instance.branchid}/courses/${widget.courseId}/fees").child("MaxInstallment").update({
       "IsMaxAllowed" : true,
    ...
    return GestureDetector(
      ...
      child: Container(
        decoration: BoxDecoration(
            borderRadius: BorderRadius.circular(20.0), color: Color(0xffF36C24)),
        width: MediaQuery.of(context).size.width,
 ...
 _loadFromDatabase() async{
  dbRef.reference().child("institute/${FireBaseAuth.instance.instituteid}/branches/${FireBaseAuth.instance.branchid}/courses/${widget.courseId}/fees").child("MaxInstallment").once()
  .then((snapshot){
    map = snapshot.value;
    setState(() {
    ...
    return Scaffold(
      ...
      body: ListView(
        ...
        children: [
          ...
          Container(
            color: noOfTextFields!=0? Color(0xffF36C24): Colors.white,
              width: MediaQuery.of(context).size.width,
