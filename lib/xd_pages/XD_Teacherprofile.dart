...
class XD_Teacherprofile extends StatelessWidget {
  XD_Teacherprofile({
    Key key,
  }) : super(key: key);
  @override
...
const String _svg_v2y25u =
    '<svg viewBox="147.5 307.5 217.0 1.0" ><path transform="translate(147.5, 307.5)" d="M 0 0 L 217 0" fill="none" stroke="#707070" stroke-width="1" stroke-miterlimit="4" stroke-linecap="butt" /></svg>';
